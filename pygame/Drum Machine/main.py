...
# MIXER IS MAIN INGREDIENT IN THIS WHOLE PROJECT
from pygame import mixer

#INITIALISING THE PYGAME
pygame.init()

# PRE-DEFINING SOME COLOR FOR BETTER READABILITY
black = (0, 0, 0)
white = (255, 255, 255)
gray = (128, 128, 128)
dark_gray = (50, 50, 50)
...
# DEFINING THE HEIGHT AND WIDTH CONSTANT
WIDTH = 1400
HEIGHT = 800
active_length = 0
active_beat = 0
...
# TO SET FPS OR SPEED OF THE LOOP
timer = pygame.time.Clock()
fps = 60

# SETTING THE DEFAULT BEATS IN A ROW
beats = 8
bpm = 240

# TOTAL NO. OF INSTUMENTS
instruments = 6

playing = True

# GRID OF THE INSTUMENTS BEAT
...
def draw_grid(clicks, beat, actives):
    ...
    # LEFT MOST COLUMN SHOWING THE INSTUMENTS
    left_box = pygame.draw.rect(screen, gray, [0, 0, 200, HEIGHT - 200], 5)
    
    # BOTTOM MOST COLUMN 
    bottom_box = pygame.draw.rect(screen, gray, [0, HEIGHT - 200, WIDTH, 200], 5)
    
    # MAKING PARTITION IN THE LEFT MOST COLUMN 
    for i in range(instruments + 1):
        pygame.draw.line(screen, gray, (0, i * 100), (200, i * 100), 3)
        
    colors = [gray, white, gray]
    
    # INSTUMENT NAMES INSERTING IN LEFT MOST COLUMN 
    ...
    # MAKING THE GRID EXCLUDING THE LEFT MOST COLUMN AND BOTTOM MOST ROW 
